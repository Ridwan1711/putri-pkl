...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Notifikasi', href: '/petugas/notifikasi' },
];
...
export default function PetugasNotifikasiIndex({ notifikasi, filters, stats }: Props) {
    ...
    const markAllAsRead = () => {
        router.post('/petugas/notifikasi/read-all', {}, {
            preserveScroll: true,
        });
    };
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-amber-100 mt-1">
                                    Pantau penugasan dan update terbaru
                                </p>
                            </div>
                            {stats.unread > 0 && (
                                <Button
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-amber-600">Belum Dibaca</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                                            ...
                                            <div className="flex items-start justify-between gap-4">
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        {!item.is_read && (
                                                            <Badge variant="default" className="bg-amber-600">Baru</Badge>
                                                        )}
