...
export default function PetugasAduanShow({ aduan }: Props) {
    ...
    const isKritikalKategori = ['Kinerja Petugas', 'Keterlambatan Pengangkutan'].includes(aduan.kategori);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                ...
                <div className="container mx-auto px-4 py-6">
                    {/* Warning for critical categories */}
                    {isKritikalKategori && (
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-red-700">
                                            Aduan ini terkait dengan kinerja petugas. Jadikan sebagai masukan untuk meningkatkan kualitas layanan.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
                                        ...
                                        <CardContent className="space-y-6">
                                            <div className="grid gap-4 sm:grid-cols-2">
                                                <div className="p-4 rounded-lg bg-gray-50">
                                                    ...
                                                    <Badge variant={isKritikalKategori ? 'destructive' : 'outline'} className="text-base">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-blue-700 mt-1">
                                                    Anda hanya dapat melihat detail aduan. Pengelolaan status dilakukan oleh Admin.
                                                </p>
                                            </div>
                                        </div>
                                    </CardContent>
